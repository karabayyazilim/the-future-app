            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex flex-col justify-center items-center">
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="w-full" action="{{route('admin.degree.update', $degree)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="flex-mx-3 mb-6 justify-center ">
                            <div class="w-full px-3 mb-6">
                                ...
                                <input
                                    ...
                                    id="grid-first-name" type="text" name="name" value="{{$degree->name}}">
                            </div>
